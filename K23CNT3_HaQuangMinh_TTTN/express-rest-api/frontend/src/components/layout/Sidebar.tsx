...
export default function Sidebar({ isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-30 flex w-64 flex-col border-r border-slate-200 bg-white/95 backdrop-blur-md shadow-sm
      ...
      >
        ...
        <div className="border-t border-slate-100 p-3">
          ...
          <p className="mt-2 text-[10px] text-center text-slate-400 font-medium truncate px-2" title={user?.thesisTitle || 'Đề tài TTTN'}>
            {user?.className || 'Đề tài TTTN - K23CNT3'} © 2026
          </p>
        </div>
      </aside>
    </>
