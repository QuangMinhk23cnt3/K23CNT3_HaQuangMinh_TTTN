...
const options = {
    ...
    definition: {
        ...
        info: {
            ...
            description: "API quản lý người dùng được xây dựng bằng Express.js và MongoDB. " +
    ...
    apis: [
        path_1.default.join(__dirname, "../routes/*.ts").replace(/\\/g, "/"),
        path_1.default.join(__dirname, "../server.ts").replace(/\\/g, "/")
    ]
};
